# Generated by Django 4.2.2 on 2023-06-15 05:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('crated_at', models.DateTimeField(default=django.utils.timezone.now, verbose_name='作成日')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='blog.category', verbose_name='カテゴリ')),
                ('tegs', models.ManyToManyField(blank=True, null=True, to='blog.tag', verbose_name='タグ')),
            ],
        ),
    ]
